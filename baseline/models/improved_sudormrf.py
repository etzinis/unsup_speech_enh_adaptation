"""!
@brief The improved SuDO-RM-RF model as described in:

[1] Tzinis, E., Wang, Z., Jiang, X. and Smaragdis, P.,
Compute and memory efficient universal sound source separation.
Journal of Signal Processing Systems, 94(2), pp.245-259, 2022.

[2] Tzinis, E., Wang, Z. and Smaragdis, P.,
Sudo rm-rf: Efficient networks for universal audio source separation.
In International Workshop on Machine Learning for Signal Processing (MLSP), pp. 1-6. 2020.

Copied from: https://github.com/etzinis/sudo_rm_rf/blob/master/sudo_rm_rf/dnn/models/improved_sudormrf.py
