""" Implementation of Mixture consistency according to the paper.
...
Copied from: https://github.com/etzinis/fedenhance/blob/master/fedenhance/experiments/utils/mixture_consistency.py
"""
